...
# marketing_analytics_project documentation build
...
from marketing_analytics_project import __version__ as release

# -- Project information -----------------------------------------------------

project = "marketing_analytics_project"
author = "Kedro"
...
htmlhelp_basename = "marketing_analytics_projectdoc"
...
latex_documents = [
    (
        master_doc,
        "marketing_analytics_project.tex",
        "marketing_analytics_project Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "marketing_analytics_project",
        "Project marketing_analytics_project codebase.",
        "Data-Science",
    )
]
